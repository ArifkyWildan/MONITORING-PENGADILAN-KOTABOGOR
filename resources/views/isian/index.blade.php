...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <a href="{{ route('isian.daftar') }}" class="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition">
                <i class="fas fa-list text-2xl text-green-600 mr-4"></i>
                <div>
                    <p class="font-semibold text-gray-900">Lihat Daftar Isian</p>
                    <p class="text-sm text-gray-600">Kelola isian Anda</p>
                </div>
            </a>
            ...
            <a href="{{ route('isian.list') }}" class="flex items-center p-4 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition">
                <i class="fas fa-eye text-2xl text-indigo-600 mr-4"></i>
                <div>
                    <p class="font-semibold text-gray-900">List Isian</p>
                    <p class="text-sm text-gray-600">Lihat semua isian</p>
                </div>
            </a>
        </div>
    </div>
        ...
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-sm mt-2 opacity-90">
                    @if(auth()->user()->isUser())
                        Anda dapat membuat isian baru dan mengelola isian yang Anda buat.
                    @elseif(auth()->user()->isVerifikator())
                        Anda dapat memverifikasi isian yang telah memiliki link.
                    @elseif(auth()->user()->isPimpinan())
                        Anda dapat melihat semua data dan statistik isian.
